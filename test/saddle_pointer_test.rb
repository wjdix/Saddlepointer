...
module SaddlePointer
  class SaddlePointerTest < MiniTest::Unit::TestCase
    def test_the_sample_arrays
      ...
      assert_equal [Point.new(3, 1)], SaddlePointer.find(arr1)
      assert_equal "No saddle points found", SaddlePointer.find(arr2)
      assert_equal [Point.new(3,1)], SaddlePointer.find(arr3)
    end

    def test_find_saddle_points_by_intersecting_row_and_column_candidates
